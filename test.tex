...
\NormalTok{  gt}\SpecialCharTok{::}\FunctionTok{as\_latex}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\toprule
\textbf{Characteristic} & \textbf{N = 19}\textsuperscript{\textit{1}} \\ 
\midrule\addlinespace[2.5pt]
temperature & 180 (80, 280) \\ 
pressure & 9 (0, 157) \\ 
\bottomrule
\end{tabular*}
